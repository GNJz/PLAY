...
def run_simulation(args):
    ...
    prm = RHSParams(
        ...
        center_GM=args.center_GM, center_eps=args.center_eps, center_k=args.center_k
    ), center_GM=args.center_GM, center_eps=args.center_eps, center_k=args.center_k), center_GM=args.center_GM, center_eps=args.center_eps, center_k=args.center_k), center_GM=args.center_GM, center_eps=args.center_eps, center_k=args.center_k), center_GM=args.center_GM, center_eps=args.center_eps, center_k=args.center_k),
        soften_ctrl_when_clamped=not args.no_soften_when_clamped,
        center_k=args.center_k, center_GM=args.center_GM, center_eps=args.center_eps
    )

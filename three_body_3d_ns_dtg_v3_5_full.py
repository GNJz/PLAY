...
def rhs_with_dtg(pos, vel, theta = split_state_with_theta(s_all, N=3)
...
if use_ed:
    ...
    ed = (E - prm.E0) / (abs(prm.E0) + 1e-15)else:
    ed = 0.0

# DTG target (+ resonance)
res_term = prm.res_amp * np.sin(prm.res_omega * t) if prm.res_amp and prm.res_omega else 0.0
